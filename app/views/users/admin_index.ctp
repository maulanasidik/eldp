              ...
              <div class="container" id="containerI">
                <div class="main" id="resume7">
                  ...
                  <ul class="rb-grid clearfix">
                    ...
                    <li class="keteranganatas gotolinkspecial areatochangebackground" data-url="<?php echo $this->webroot;?>admin/photos/add" data-title="Tambah Photos" data-width="900px" data-height="375px">
    ...
    <!-- // Resume Part -->         
              <ul class="rb-grid clearfix overlay-grids">
                ...
                <li class="rb-span-12">
                  ...
                  <h3 style="margin-top: 180px;" class="menufirst">
                    <a class="changepage listbukuactive" data-countinside="1" href="<?php echo $this->webroot;?>admin/notifications/listnotifications" data-scope="notificationscope" data-background="#109079" data-fontcolor="#537E40">List Pengumuman</a>
                  </h3>

                  <h3>
                    <a class="changepage listbukuactive" data-countinside="2" href="<?php echo $this->webroot;?>admin/notifications/listnotifications_active" data-scope="notificationscope" data-background="#109079" data-fontcolor="#537E40">List Pengumuman Aktif</a>
                  </h3>


                  <h3>
                    <a class="changepage listbukuactive" data-countinside="3" href="<?php echo $this->webroot;?>admin/notifications/listnotifications_notactive" data-scope="notificationscope" data-background="#109079" data-fontcolor="#537E40">List Pengumuman Tidak Aktif</a>
                  </h3>


                  <h3>
                    <a class="changepage listbukuactive" data-countinside="4" href="<?php echo $this->webroot;?>admin/notifications/listnotifications_willactive" data-scope="notificationscope" data-background="#109079" data-fontcolor="#537E40">List Pengumuman Akan Aktif</a>
                  </h3>
    ...
    <!-- // Social network -->
     ...
     <!-- Download vcard page box5 -->
          ...
          <div class="container1" id="containerI">
            <div class="main" id="resume6">
              ...
              <ul class="rb-grid clearfix overlay-grids" id="slide">
                ...
                <li class="keteranganatas gotolink areatochangebackground" data-url="<?php echo $this->webroot;?>admin/ebooks/add/2" data-title="Tambah Ebooks" data-width="900px" data-height="375px">
      ...
      <li class="rb-span-2">
            ...
            <div class="main" id="resume4">
              ...
              <ul class="rb-grid clearfix overlay-grids" id="slide">
                ...
                <li class="rb-span-12">
                  ...
                  <div id="a" class="pusmul imageNavinside">&nbsp;</div>
                    
                    <h3 style="margin-top: 180px;" class="menufirst">
                      <a class="changepage" data-countinside="1" href="<?php echo $this->webroot?>admin/subjects/listcd" data-scope="pusmulscope" data-background="#16d22a" data-fontcolor="#169dd1">List Pustaka Multimedia</a>
                    </h3>
                    
                    <h3>
                      <a class="changepage" data-countinside="2" href="<?php echo $this->webroot?>admin/subjects/showfavorite" data-scope="pusmulscope" data-background="#16d22a" data-fontcolor="#169dd1">Favorite</a>
                    </h3>


                    <h3>
                      <a class="changepage" data-countinside="3" href="<?php echo $this->webroot?>subjects/admin_find" data-scope="pusmulscope" data-background="#16d22a" data-fontcolor="#169dd1">Pencarian</a>
                    </h3>
                    ...
                    <div class="mask1">
                        <div class="actions">
                          ...
                          <div class="tohide">
                            ...
                            <div class="favoritebukucontent countinside_2_container" style="display:none;">
                              <div class="top_line">&nbsp;</div>
                              <div class="name">List Pustaka Multimedia Favorite<br/></div>
                              <div class="tags">Semua Pustaka Multimedia yang terdaftar sebagai Favorite</div>
                              <div class="bottom_line">&nbsp;</div>
                            </div>

                            <div class="favoritebukucontent countinside_3_container" style="display:none;">
                                  <div class="top_line">&nbsp;</div>
                                  <div class="name">Pencarian Pustaka Multimedia<br/></div>
                                  <div class="tags">
                            ...
                            <div class="favoritebukucontent countinside_4_container" style="display:none;">
                              <div class="top_line">&nbsp;</div>
                              <div class="name">Cetak Daftar Pustaka Multimedia<br/></div>
                              <div class="tags">Mencetak list Pustaka Multimedia yang terdaftar</div>
                              <div class="bottom_line">&nbsp;</div>
                            </div>
                ...
                <li class="keteranganatas gotolink areatochangebackground" data-url="<?php echo $this->webroot;?>admin/subjects/add" data-title="Tambah Pustaka Multimedia" data-width="900px" data-height="375px">
                    ...
                    <div class="centercontainer">
                      ...
                      <div class="tohide">
                        ...
                        <div class="listbukucontent">
                          ...
                          <span>Tambah List Pustaka Multimedia</span>
                        </div>
                ...
                <li class="pusmulscope contentareatoload areatochangebackground">
        ...
        <div class="pusmul loaddefaultcontent" data-href="<?php echo $this->webroot;?>admin/subjects/listcd" data-scope="pusmulscope" data-background="#16d22a" data-fontcolor="#169dd1">&nbsp;</div>
