<?php if(empty($member)): ?>
<p id="emptymember">emptymember</p>
<?php else:?>
<?php 
...
<div class="mask1 metro content_transaction_container transactionproccess">
	<div class="transp actions">
		<div class="transpcontent">
  			<div class="actions">
				<p class="instructions"> Anda akan menambahkan transaksi untuk member dengan detail dibawah, silahkan pilih tipe transaksi di tab bawah,<br/> setelah selesai, klik tombol selesai</p>
				<?php
				$i = 0;
				$n = 0;
				...
				<div style="float:right;margin-right: 30px;">
					<a class="image-button bg-darkGreen fg-white image-left finish-rents" data-countinside="1" data-url="<?php echo $this->webroot;?>admin/rents/list" data-scope="rentscope" data-background="#df9019 " data-fontcolor="#C2F15F" style="color: rgb(194, 241, 95);" href="#!/url=<?php echo $this->webroot;?>admin/rents/list">
		    		SELESAI
		...
		<div class="tab-control tabrents" data-role="tab-control">
	        ...
	        <div class="frame" id="_page_1" style="display: none;">
				...
				<div id="table_rent_process" style="display:none;">
					<table class="table tables tables hovered" cellpadding="0" cellspacing="0">
						<thead>
	        ...
	        <div class="frame" id="_page_2" style="display: none;">
	            <table class="table tables hovered" cellpadding="0" cellspacing="0">
			    	<thead>
			        <tr class="title_table">
						<th class="smallest-row"><?php echo ('ID Transaksi');?></th>
						<th class="largest-row"><?php echo ('Judul Buku');?></th>
	        ...
	        <div class="frame" id="_page_3" style="display: block;">
	            ...
	            <?php if(!empty($duetoday)):?>
	                ...
	                <table class="table tables hovered" cellpadding="0" cellspacing="0" id="pengembalian_duetoday">
						<thead>
							<tr class="title_table">
							<th class="smallest-row"><?php echo ('ID Transaksi');?></th>
							<th class="largest-row"><?php echo ('Judul Buku');?></th>
						...
						<tbody>
							...
							<td><?php echo $item['Book']['title']; ?></td>
							<td><?php echo $item['User']['name']; ?></td>
							<td><?php echo waktuindo($item['Rent']['tgl_kembali']); ?></td>
							<td class="smallest-row" id="kembali_<?php echo $item['Rent']['id'];?>">
								<i class="icon-loop on-left"style="background: #bb0000;color: white;padding: 4px;border-radius: 50%;font-size: 10px;"></i>Dipinjam
							</td>
							<td class="actions3">
	            ...
	            <table class="table tables hovered" cellpadding="0" cellspacing="0" id="pengembalian_duetoday">
			        ...
			        foreach ($duemore as $item) : ?>
			        	<tr class="altrow " id="pengembalian_<?php echo $item['Rent']['id'];?>">
							...
							<td><?php echo $item['User']['name']; ?></td>
							<td><?php echo waktuindo($item['Rent']['tgl_kembali']); ?></td>
							<td class="smallest-row" id="kembali_<?php echo $item['Rent']['id'];?>"><i class="icon-loop on-left"style="background: #bb0000;color: white;padding: 4px;border-radius: 50%;font-size: 10px;"></i>Dipinjam</td>
			          		<td class="actions3">
				            <a class="doback" href="<?php echo $this->webroot;?>admin/rents/view_back/<?php echo $item['Rent']['id']; ?>">
				            	<i class="icon-exit on-right"></i> Kembali
				            </a>
				            <a class="doback" href="<?php echo $this->webroot;?>admin/rents/view_broke/<?php echo $item['Rent']['id']; ?>">
				            	<i class=" icon-blocked on-right"></i> Rusak
				            </a>
			          		</td>
			        	</tr>
			        <?php endforeach;?>
	...
	</div><!--end transpaction-->
</div><!-- end content_transaction_container-->
