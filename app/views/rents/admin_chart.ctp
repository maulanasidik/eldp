...
<script>
    ...
    var chart = AmCharts.makeChart("chartdiv", {
	    ...
	    {
	      size: 20,
	      text: "Jumlah Transaksi Peminjaman Tahun <?php echo $year;?>"
	    }
	  	],
...
<div class="mask1 contenareaajax">
	...
	<div id="dropdownyear_container">
		...
		<select id="dropdownyear">
		  <option id="yearselected_<?php echo $cur_year?>" value="<?php echo $this->webroot.'admin/users#!/url=/eldp/admin/rents/chart/'.$cur_year?>" ><?php echo $cur_year;?></option>
		  <option id="yearselected_<?php echo ($cur_year-1)?>" value="<?php echo $this->webroot.'admin/users#!/url=/eldp/admin/rents/chart/'.($cur_year-1);?>" ><?php echo $cur_year-1;?></option>
		  <option id="yearselected_<?php echo ($cur_year-2)?>" value="<?php echo $this->webroot.'admin/users#!/url=/eldp/admin/rents/chart/'.($cur_year-2);?>" ><?php echo $cur_year-2;?></option>
		</select>
	</div>
